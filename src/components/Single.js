    ...
    <div >
      ...
      <div className="w-full h-[80vh] flex justify-center items-center gap-[100px]">
        <img
          ...
          className="w-[30%] h-[90%] border-[30px] border-[rgba(0,0,0,0.7)] rounded-[30px] md:hidden"
        />
        <div className="w-[45%] h-[90%] p-[20px] bg-[rgba(0,0,0,0.61)] rounded-[30px] flex flex-col gap-5 md:h-[600px] md:x-[90%] ">
      ...
      <div className="w-full h-[300px] pt-5">
        ...
        <div className="flex gap-6 overflow-x-scroll ">
          {video.map((e) => {
            return (
              <div key={e.key}>
                <div className="relative" onClick={() => setVid(e.key)}>
                  <iframe
                    allowFullScreen
      ...
      {vid !== "" ? (
        <div
          className="w-full h-screen fixed z-50 bg-[rgba(0,0,0,0.76)] top-0 flex justify-center items-center cursor-pointer p-10"
          onClick={() => setVid("")}
        >
          <iframe
            allowFullScreen
