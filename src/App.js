...
import Layout from "./Layout";const ganre = [
  { id: 28, name: "action" },
...
function App() {
  ...
  return <div className="flex justify-center items-center gap-[30px] flex-wrap">
    ...
    <div className="flex justify-center items-center gap-[30px] flex-wrap py-5   md:flex-nowrap md:justify-start md:overflow-x-scroll m-x-4 ">
      {ganres.map((e, i) => {
